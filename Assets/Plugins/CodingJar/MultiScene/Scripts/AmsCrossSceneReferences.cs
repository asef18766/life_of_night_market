...
#endif
    {
		// We are versioning now.  2018.3 has a prefab serialization change.
#if UNITY_2018_3_OR_NEWER
		const int CurrentSerializedVersion = 2;
#else
		const int CurrentSerializedVersion = 1;
#endif
		[SerializeField, HideInInspector]	int							_version = CurrentSerializedVersion;
